(function (global, factory) {
	...
	(global = global || self, factory(global.SvcPoolCore = {}));
	...
	function createDefPool() {
		return []
	}

	function registerSvcDef(defPool, svcDef) {
		const next = [...defPool, svcDef];

		return next
	}

	function registerSvcDefs(defPool, svcs) {
		const init = [...defPool];
	...
	function resolveDefPool(defPool) {
	...
	const createSvcDef = ({ desc = '', deps = {}, ...other }) => {
		let theDeps = {};
	...
	exports.createDefPool = createDefPool;
	exports.createSvcDef = createSvcDef;
	exports.registerSvcDef = registerSvcDef;
	exports.registerSvcDefs = registerSvcDefs;
	exports.resolveDefPool = resolveDefPool;
